        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="invoice_no" value="{{ $purchase_data->invoice_no ?? ''}}" id="invoice_no" readonly>
                    <code class="text-danger small font-weight-bold float-right" id="name_error" style="display: none;"></code>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control form-control-sm purchase_date" name="purchase_date" value="{{ $purchase_data->tran_date }}" id="purchase_date">
                    <code class="text-danger small font-weight-bold float-right" id="name_error" style="display: none;"></code>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <table class="table table-bordered table-striped mt-2 row_add purchase_table">
                ...
                <tbody class="append_row">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="generic_name[]" value="{{ $purchase_data->brand_name }}" class="form-control form-control-sm generic_name" readonly/>
                            <input type="hidden" name="generic_id[]" value="{{ $purchase_data->generic_id }}" class="form-control form-control-sm generic_id" readonly/>
                        </td>
                        <td><input type="text" name="price[]" value="{{ $purchase_data->price }}" class="form-control form-control-sm price" readonly/></td>
                        <td><input type="text" name="qty[]" value="{{ $purchase_data->qty }}" class="form-control form-control-sm qty" /></td>
                        <td><input type="text" name="total[]" value="{{ $purchase_data->total_price }}" class="form-control form-control-sm total" readonly/></td>
                        <td>
